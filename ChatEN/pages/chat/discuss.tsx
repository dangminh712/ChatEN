...
function ChatVoice() {
  ...
  useEffect(() => {
    const initialHistory: chatHistory[] = [
      {
        role: "user",
        parts: `Bạn sẽ trong vai 1 ChatVoice để trả lời câu hỏi của hệ thống học tập và mua bán sách CHATEN, hãy đề xuất sách mà người dùng đang tìm kiếm, đưa họ đường dẫn với URL là 'http://localhost:3000/course/{ID của quyển sáchh}'(nhớ là http thôi): ${policy}`,
      },
      {
        role: "model",
        parts: "Xin chào, tôi là ChatVoice của hệ thống CHATEN, bạn cần hỏi gì ?",
      },
    ];
