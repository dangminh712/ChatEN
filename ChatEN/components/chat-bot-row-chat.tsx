...
import { sentences, transcripts, transcriptss } from "../types/typeSystem";
...
const RowChatBot = (props: Props) => {
  return (
    <div>
      <div className="chat__conversation-board__message-container">
        <div className="chat__conversation-board__message__person">
          <div className="chat__conversation-board__message__person__avatar  w-[50px] h-[50px]">
            <img
              src="https://todai.ai/wp-content/uploads/ChatBot-Lightblue-1.png"
              alt="Monika Figi"
            />
          </div>
        </div>
