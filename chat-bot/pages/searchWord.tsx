...
let temp: dataTraCau = { language: 'en', sentences: [{
  _id: "123123",
  fields: {
      en: "<b>Xin chào bạn<b>",
      vi: "Vui lòng nhập từ bạn muốn tôi search"
  }
}], suggestions: [], tratu: [] };
function SearchWord() {
  const [data, setData] = useState<dataTraCau>(temp)
     ...
     {userchat}
        ...
        <div className="chat__conversation-panel">
          <div className="chat__conversation-panel__container">
            ...
            <button className="chat__conversation-panel__button panel-item btn-icon send-message-button" onClick={handleClick}>
